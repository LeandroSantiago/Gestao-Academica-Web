...
import br.com.santiago.clinicajm.repository.ConsultaRepository;
...
public class ConsultaController {
	...
	@RequestMapping(value="/agendar.do", method=RequestMethod.POST)
	 public String agendar(Consulta consulta, String data, 
	 String hora, Model model) {
	   ...
	   try {
	     ...
	     model.addAttribute("mensagem", new MensagemUtil("Sucesso ao cadastrar a consulta", TipoMensagem.SUCESSO));
	   } catch (ParseException e) {
	     model.addAttribute("mensagem", new MensagemUtil("Erro ao fazer a conversão de data/hora. Observe os padrões a serem seguidos", TipoMensagem.ERRO));
	   }
